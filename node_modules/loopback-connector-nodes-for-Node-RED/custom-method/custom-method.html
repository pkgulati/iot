...
<script type="text/x-red" data-template-name="custom-method">
    ...
    <div class="form-row">
        <label for="node-input-methodname"><i class="icon-tag"></i> Method</label>
        <input type="text" id="node-input-methodname" placeholder="Method">
    </div>
    ...
    <div class="form-row">
        <label for="node-input-outputs"><i class="fa fa-random"></i>Number of Outputs</label>
        <input id="node-input-outputs" style="width: 60px;" value="1">
    </div>
    <div class="form-tips">See Info Tab</div>
</script>

<script type="text/x-red" data-help-name="custom-method">
...
<script type="text/javascript">
    RED.nodes.registerType('custom-method',{
        color:"#fdd0a2",
        category: 'function',
        defaults: {
            name: {value:""},
